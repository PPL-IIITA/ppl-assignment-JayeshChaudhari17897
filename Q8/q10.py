...
from q10_random import random1
...
for j in range(row_count_girls):
	for i in range(row_count_boys):
		...
		random_boys = random1()
		random_boys.random_of_n(boy_array ,row_count_boys )# this makes the array of boys as random array using module q10_random.py
...
for i in range(k):
	gift_store = random1()
	gift_store.random_of_n(gift_array , row_count_gifts)
